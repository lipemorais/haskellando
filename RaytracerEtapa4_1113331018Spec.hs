import Test.Hspec
import RaytracerEtapa4_1113331018
...
main = hspec $ do
  ...
  describe "Raio typeclass" $ do
    it "is OK with type Raio of Raytracer" $ do
      Raio (Coordenada(1, 2, 3)) (Coordenada(1, 2, 3)) `shouldBe` Raio (Coordenada(1, 2, 3)) (Coordenada(1, 2, 3))